...
export interface AppConfig {
    ...
    "clash-log":                string;
    "crontab-log":              string;
    "uclash-service":           string;
    "ui-branch":                string;
    "ui-folder":                string;
    "config-branch":            string;
    "config-folder":            string;
    "serve-folder":             string;
    "serve-hook-folder":        string;
    "cache-folder":             string;
    "tmp-folder":               string;
...
const default_config:AppConfig={
    ...
    "serve-folder": "{HOME}/.config/uclash/serve/",
    "serve-hook-folder": "{HOME}/.config/uclash/serve-hook/",
    ...
    "pacs": [
        {
            ...
            "description":"无法正常访问的网址列入黑名单，pac对黑名单网址使用代理，其余不代理，容易漏过一些网站，但理论更快速",
            "name": "black.pac",
            "base": [
        ...
        },
        {
            ...
            "description":"确认可以正常访问的网址列入白名单，pac对白名单网址直连，其余走代理",
            "name": "w2.pac",
            "base": [
            ...
            "replace": [
                [
                    ...
                    "SOCKS5 @ip:@socks; SOCKS @ip:@socks;"
                ],
                [
                    "host=\"\"+host;",
                    "host = '' + host;if (@host) { return 'PROXY 192.168.1.6:7890'; }"
                ]
            ]
        },
        {
