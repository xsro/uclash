...
export type CurlOpts = { [id: string]: string }
type cURL = (url: string, opts: CurlOpts) => string
...
export class Config {
    curl?: CURL;
    cURL: cURL = function (url: string, opt: CurlOpts) {
        throw new Error("curl is not implemented")
    };;
    _projectFolder = "";
    custom_Config_Paths = [
