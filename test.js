...
// w2.pac 8/12/2022, 10:16:43 PM
// base: https://cdn.jsdelivr.net/gh/breakwa11/gfw_whitelist@master/whitelist.pac,https://raw.githubusercontent.com/breakwa11/gfw_whitelist/master/whitelist.pac

function matchRuleShort(str, rule) {
    var escapeRegex = (str) => str.replace(/([.*+?^=!:${}()|\[\]\/\\])/g, "\\$1");
    return new RegExp("^" + rule.split("*").map(escapeRegex).join(".*") + "$").test(str);
}
var wall_proxy = "SOCKS5 127.0.0.1:undefined; SOCKS 127.0.0.1:undefined;";
...
function FindProxyForURL(url, host) {
	url=""+url;
	host = '' + host;if (['clash','*.clash.dev'].some(h => matchRuleShort(host,h))) { return 'PROXY 192.168.1.6:7890'; }
