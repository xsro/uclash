...
export const projectFolder = statSync(process.argv[1]).isDirectory()
    ? process.argv[1]
    : dirname(process.argv[1]);
console.log(projectFolder)

const _defaultConfig = {
    "uclash-config": "{persist}/config.json",
    ...
    "win32.persist-folder": "E:\\home\\.config\\uclash",
}
export const _c = _defaultConfig;
const pathProperty = [
    "ui-folder", "config-folder", "cache-folder", "uclash-config", "persist-folder"
]
